 ...
 */
export function classifyContent(content: string): PrivacyTag {
 ...
 */
export function canInject(cell: Cell, contextScope: string): PrivacyDecision {
 ...
 */
export function filterInjectable(cells: Cell[], contextScope: string): Cell[] {
