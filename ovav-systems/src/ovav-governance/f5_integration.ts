...
import { validateArchitecture, type ValidationResult as F1Result } from "./f1_architecture.js";
import { validateInfrastructure, type ValidationResult as F2Result } from "./f2_infrastructure.js";
import { validateRoles, type ValidationResult as F3Result } from "./f3_roles.js";
import { validateSecurity, type ValidationResult as F4Result } from "./f4_security.js";
...
export async function validateF5(basePath: string): Promise<F5Report> {
...
export async function validateF0(_basePath: string): Promise<ValidationResult> {
