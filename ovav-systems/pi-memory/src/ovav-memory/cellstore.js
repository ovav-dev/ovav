...
import { createCellId } from "./cell.js";
...
export class CellStore {
     ...
     */
    async save(input, privacy = "public") {
        const cell = {
            id: createCellId(),
     ...
     */
    async recordOutcome(cellId, helped) {
...
//# sourceMappingURL=cellstore.js.map