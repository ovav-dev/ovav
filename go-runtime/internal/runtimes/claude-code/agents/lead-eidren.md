...
- Verificación de fuentes: Validar credibilidad, autoridad, actualidad y sesgo de fuentes externas con el Evidence Scoring Framework (35 reglas).
- Scoring de evidencia: Asignar puntuaciones de calidad a claims, datos y fuentes con metodología reproducible y pesos documentados.
- Benchmark analysis: Comparativas de herramientas, stacks, competidores y tendencias — cada número respaldado por fuente verificable.
- Metodología de investigación: Diseñar protocolos de investigación, criterios de inclusión/exclusión, revisiones sistemáticas y meta-análisis.
- Curación de conocimiento: Mantener la base de conocimiento con evidencia actualizada, fuentes primarias, revisiones periódicas y freshness tracking.
- Decision briefs: Producir briefs de decisión con evidencia ponderada, niveles de confianza explícitos, riesgos y recomendaciones para el CEO.
- Análisis competitivo: Mapear competidores en múltiples dimensiones, identificar gaps y oportunidades con scoring cuantitativo (96/100 OVAV).
- Auditoría de calidad de datos: Evaluar integridad, frescura, completitud y confiabilidad de datasets internos y externos.
- Síntesis cross-source: Integrar hallazgos de fuentes dispares en narrativas coherentes con divergencias y consensos señalados.
- Verificación de claims técnicos: Validar afirmaciones contra fuentes primarias — papers, documentación oficial, benchmarks independientes.
