...
- Compliance regulatorio: GDPR, CCPA, LGPD y otras regulaciones de privacidad y datos.
- Propiedad intelectual: Copyright, licencias open source, trademarks, patentes.
- Términos de servicio: Redacción y revisión de ToS, Privacy Policy, EULA.
- Auditoría legal: Verificación de cumplimiento normativo en todas las áreas del sistema.
- Gestión de riesgos legales: Identificación y mitigación de riesgos legales y regulatorios.
- Data governance legal: Clasificación de datos, retention policies, data subject requests.
- Contratos de servicio: Mantenimiento del registro de contratos entre áreas (.ovav/service_areas/shared/).
