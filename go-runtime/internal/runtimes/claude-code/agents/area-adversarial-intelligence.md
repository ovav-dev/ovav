...
- Red Team Operations: Ataques simulados controlados contra el sistema OVAV para descubrir vulnerabilidades.
- Boundary Testing: Pruebas de límites entre áreas, verificación de hard stops y handoffs.
- Race Condition Hunting: Búsqueda y explotación controlada de condiciones de carrera entre servicios.
- Architectural Auditing: Auditoría de arquitectura desde perspectiva adversarial — puntos ciegos.
- Semantic Drift Detection: Detección de deriva semántica en outputs, handoffs y contratos entre áreas.
- Prompt Injection Testing: Pruebas de inyección adversarial contra agentes y sistemas LLM.
- Supply Chain Attack Simulation: Simulación de ataques a dependencias, artefactos y pipelines.
- Adversarial Report Generation: Reportes de hallazgos con severidad, vector de ataque y mitigación.
