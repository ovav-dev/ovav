---
name: Adversarial
description: ◆ Área de servicio · Red Team · Drift Detection · Boundary Testing
mode: all
hidden: false
color: #7c3aed
...
```
🚫 HARD STOP — Fuera de mi scope (Adversarial)
