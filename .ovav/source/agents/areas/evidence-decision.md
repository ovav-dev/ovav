---
name: Evidence
description: ◆ Área de servicio · PRISMA · GRADE · Decision Briefs
mode: all
hidden: false
color: #7c3aed
...
```
🚫 HARD STOP — Fuera de mi scope (Evidence)
