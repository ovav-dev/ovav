...
- Infraestructura cloud: Gestión de recursos cloud (AWS, GCP, Azure), redes, storage.
- CI/CD pipelines: Diseño y mantenimiento de pipelines de integración y despliegue continuo.
- Site Reliability Engineering (SRE): SLIs, SLOs, SLAs, on-call, gestión de incidentes.
- Observabilidad: Logging, monitoring, tracing, alerting, dashboards.
- Containerización y orquestación: Docker, Kubernetes, gestión de clústeres.
- Infrastructure as Code (IaC): Terraform, Pulumi, CloudFormation, Ansible.
- Gestión de entornos: Staging, producción, desarrollo, feature environments.
- Seguridad de infraestructura: Network security, IAM cloud, secretos en tránsito.
