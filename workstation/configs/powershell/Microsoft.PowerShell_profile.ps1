...
function ovv { & ovav validate @args }
Set-Alias -Name ovv -Value ovv -Force
...
if ($ovavIsLight) {
    # $Host.UI.RawUI.BackgroundColor = '#hex'
    # $Host.UI.RawUI.ForegroundColor = '#hex'
} else {
    # $Host.UI.RawUI.BackgroundColor = '#hex'
    # $Host.UI.RawUI.ForegroundColor = '#hex'
}
